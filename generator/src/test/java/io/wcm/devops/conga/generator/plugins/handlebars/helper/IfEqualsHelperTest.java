...
class IfEqualsHelperTest {
  ...
  void testEquals() throws Exception {
    ...
    assertHelper(FN_RETURN, helper, List.of("a", "b", "c"), new MockOptions(List.of("a", "b", "c")));
  }

  @Test
  void testNotEquals() throws Exception {
    assertHelper("", helper, "abc", new MockOptions("def"));
    assertHelper("", helper, List.of("a", "b", "c"), new MockOptions(List.of("d", "e", "f")));
  }
